...
def consecutive_frames_check(predicted_class, consecutive_frames):
...
# Initialize the consecutive frame
consecutive_frames = {0: 0, 1: 0, 2: 0, 3: 0, 4: 0}
for gesture in predict_gesture(cap, model_path):
    print(consecutive_frames_check(gesture,consecutive_frames))
