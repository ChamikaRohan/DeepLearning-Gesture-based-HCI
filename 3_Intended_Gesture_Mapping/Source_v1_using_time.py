...
def predict_gesture(cap, model_path):
    ...
    gesture_count = {0: 0, 1: 0, 2: 0, 3: 0, 4: 0}
    ...
    while True:
        ...
        if time.time() - start_time >=1:
            ...
            if gesture_count[max_gesture] > 0:
                print("Gesture in the last 1 seconds:", max_gesture)
            else:
                print("No gesture detected in the last 1 seconds.")
            start_time = time.time()
            gesture_count = {0: 0, 1: 0, 2: 0, 3: 0, 4: 0}  # Reset gesture count
